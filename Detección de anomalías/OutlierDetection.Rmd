...
Sin embargo en la primera gráfica, correpondiente a la variable _number of people_ , si me interesan unos valores que no están del todo cohesionados. Lo mantenemos en mente, porque nos puede servir para un test de Grubb o para uno de grosner.
